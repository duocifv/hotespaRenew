...
<cc1:Panel id="pnl宿泊者1" runat="server" Visible="False">
    ...
    <TH>姓</TH>
    <TD>
    <cc1:TextBox id="txt姓宿泊者1" runat="server" CssClass="ImeActive nam_k" ImeMode="Active">
    </cc1:TextBox> </TD>
    <TH>名</TH>
    <TD>
    <cc1:TextBox id="txt名宿泊者1" runat="server" CssClass="ImeActive nam_k" ImeMode="Active">
    </cc1:TextBox> </TD>
    </TR>
    <TR>
    <TH>セイ</TH>
    <TD>
    <cc1:TextBox id="txtセイ宿泊者1" runat="server" CssClass="ImeActive nam_f" ImeMode="Active">
    </cc1:TextBox> </TD>
    <TH>メイ</TH>
    <TD>
    <cc1:TextBox id="txtメイ宿泊者1" runat="server" CssClass="ImeActive nam_f" ImeMode="Active">
    </cc1:TextBox> </TD>
    </TR>
    </TBODY>
    </TABLE>
    ...
    <TD class="sp">
    <cc1:TextBox id="txt会社名漢字" runat="server" CssClass="ImeActive com_k" ImeMode="Active">
    </cc1:TextBox> </TD>
    </TR>
    <TR>
    <TH class="sp">会社名・団体名（全角フリガナ）</TH>
    <TD class="sp">
    <cc1:TextBox id="txt会社名カナ" runat="server" CssClass="ImeActive com_f" ImeMode="Active">
    </cc1:TextBox> </TD>
    </TR>
    </TBODY>
    </TABLE>
...
<cc1:Panel id="pnl宿泊者" runat="server" Visible="False">
    ...
    <TR>
    <TD class="sp">セイ <cc1:TextBox id="txtセイ宿泊者" runat="server" CssClass="ImeActive nam_f" ImeMode="Active">
    </cc1:TextBox> 　 メイ <cc1:TextBox id="txtメイ宿泊者" runat="server" CssClass="ImeActive nam_f" ImeMode="Active">
    </cc1:TextBox> 　 <SPAN class="ex">（全角ひらがなもしくは全角カタカナ）</SPAN>
    </TD>
    </TR>
    <TR>
    <TD>　 <cc1:RadioButton id="rdo男性宿泊者" runat="server" GroupName="性別宿泊者" Text="男性">
...
<cc1:Panel id="pnl連絡先" runat="server" Visible="False">
    <cc1:TextBox id="txt連絡先" runat="server" CssClass="ImeDisabled tel" ImeMode="Disabled">
    </cc1:TextBox> 　<SPAN class="att">予約に関して施設より連絡をする場合がございます。</SPAN> <SPAN class="ex">（携帯・自宅・会社等の電話番号）</SPAN>
</cc1:Panel>
...
<cc1:GridView id="gv宿泊者情報" runat="server" GridLines="None" CssClass="odd_t info th" CellSpacing="1" AutoGenerateColumns="False" __designer:wfdid="w150" OnRowDataBound="gv宿泊者情報_RowDataBound"><Columns>
    ...
    <cc1:Panel id="pnl宿泊者1" runat="server" Visible="False">
        ...
        <TBODY>
        <TR>
        <TD class="sp">セイ <cc1:TextBox id="txtセイ宿泊者1" runat="server" CssClass="ImeActive nam_f" ImeMode="Active">
        </cc1:TextBox>　　 メイ <cc1:TextBox id="txtメイ宿泊者1" runat="server" CssClass="ImeActive nam_f" ImeMode="Active">
        </cc1:TextBox> <SPAN class="ex">（全角ひらがなもしくは全角カタカナ）</SPAN>
        </TD>
        </TR>
        <TR>
