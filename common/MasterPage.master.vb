...
NameSpace Com.Fujitsu.Hotespa.Web.User.Common
            ...
            Try
                ...
                Select Case Me.Attributes.Item("type")
                    ...
                    Case "Resort"
                        ...
                        title.Text = "【公式】共立リゾート｜リゾートホテル・温泉旅館の宿泊予約 - ホテスパ"

                        '/Resort/ の場合の metaデータ
                        metaDescript.Content = "【ホテスパ：共立リゾート】がご提供するのは、皆様の「行きたい！」に合わせてお選びいただける、お得でベストなプラン。日本有数のリゾート 各地に共立メンテナンスが展開中の「リゾートホテル・温泉旅館」を、ホテスパで、どこよりも便利に、お得にご予約いただけます。"
                        metaKeywords.Content = "共立リゾート,リゾートホテル,温泉旅館,予約,宿泊,スパ,温泉,ホテスパ,hotespa"
    ...
    #region "リンクの設定"
        ...
        Private Const GBIZ_REF As String = "../global/"
        Private Const GRES_REF As String = "../global/"
        ...
        Private Const NV5Y_REF As String = "../Members/MemberInfoTop_Corp.aspx"
